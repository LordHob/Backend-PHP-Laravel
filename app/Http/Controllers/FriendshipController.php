...
class FriendshipController extends Controller
{
    ...
    public function addFriend(Request $request)
    {
        ...
        try {
            ...
            $friend = Friendship::where(function ($query) use ($userId1) {
    ...
    public function getFriends()
    {
        ...
        try {
            ...
            return Friendship::all()->where('userId1', '=', $id)->where('accepted', '=', 1);
        } catch (QueryException $error) {
    ...
    public function getPendingFriends()
    {
        ...
        try {
            ...
            return Friendship::all()->where('userId1', '=', $id)->where('accepted', '=', 0);
        } catch (QueryException $error) {
    ...
    public function getPendingFriendRequest()
    {
        ...
        try {
            ...
            return Friendship::all()->where('userId2', '=', $id)->where('accepted', '=', 0);
        } catch (QueryException $error) {
    ...
    public function acceptFriend(Request $request)
    {
        ...
        try {
            ...
            return Friendship::where('userId2', '=', $userId1)->where('userId1', '=', $userId2)->where('accepted', '=', '0')->update($accept);
        } catch (QueryException $error) {
    ...
    public function removeFriend(Request $request)
    {
        ...
        $friendFound = Friendship::where(function ($query) use ($userId1) {
            $query->where('userId1', '=', $userId1)
                ->orWhere('userId2', '=', $userId1);
        })
            ->where(function ($query) use ($userId2) {
