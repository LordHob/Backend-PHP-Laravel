...
Route::middleware('auth:api')->group(function () {
    ...
    Route::post('getFriends', [FriendshipController::class, 'getFriends']);
    Route::post('getPendingFriends', [FriendshipController::class, 'getPendingFriends']);
    Route::post('getPendingFriendRequest', [FriendshipController::class, 'getPendingFriendRequest']);
    Route::put('acceptFriend', [FriendshipController::class, 'acceptFriend']);
    Route::delete('removeFriend', [FriendshipController::class, 'removeFriend']);
